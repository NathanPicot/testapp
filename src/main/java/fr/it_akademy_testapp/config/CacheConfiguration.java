...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, fr.it_akademy_testapp.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, fr.it_akademy_testapp.repository.UserRepository.USERS_BY_EMAIL_CACHE);
