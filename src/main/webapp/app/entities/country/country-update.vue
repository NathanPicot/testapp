  ...
  <div class="row justify-content-center">
    <div class="col-8">
      <form name="editForm" role="form" novalidate v-on:submit.prevent="save()">
        <h2
          id="testappApp.country.home.createOrEditLabel"
          data-cy="CountryCreateUpdateHeading"
          v-text="t$('testappApp.country.home.createOrEditLabel')"
        ></h2>
        <div>
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="t$('testappApp.country.countryName')" for="country-countryName"></label>
            <input
              type="text"
              class="form-control"
              name="countryName"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="t$('testappApp.country.region')" for="country-region"></label>
