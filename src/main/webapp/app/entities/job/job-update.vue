  ...
  <div class="row justify-content-center">
    <div class="col-8">
      <form name="editForm" role="form" novalidate v-on:submit.prevent="save()">
        <h2
          id="testappApp.job.home.createOrEditLabel"
          data-cy="JobCreateUpdateHeading"
          v-text="t$('testappApp.job.home.createOrEditLabel')"
        ></h2>
        <div>
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="t$('testappApp.job.jobTitle')" for="job-jobTitle"></label>
            <input
              type="text"
              class="form-control"
              name="jobTitle"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="t$('testappApp.job.minSalary')" for="job-minSalary"></label>
            <input
              type="number"
              class="form-control"
              name="minSalary"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="t$('testappApp.job.maxSalary')" for="job-maxSalary"></label>
            <input
              type="number"
              class="form-control"
              name="maxSalary"
          ...
          <div class="form-group">
            <label v-text="t$('testappApp.job.task')" for="job-task"></label>
            <select
              class="form-control"
              id="job-tasks"
              data-cy="task"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="t$('testappApp.job.employee')" for="job-employee"></label>
