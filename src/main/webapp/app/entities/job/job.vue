<template>
  <div>
    <h2 id="page-heading" data-cy="JobHeading">
      <span v-text="t$('testappApp.job.home.title')" id="job-heading"></span>
      <div class="d-flex justify-content-end">
        <button class="btn btn-info mr-2" v-on:click="handleSyncList" :disabled="isFetching">
          <font-awesome-icon icon="sync" :spin="isFetching"></font-awesome-icon>
          <span v-text="t$('testappApp.job.home.refreshListLabel')"></span>
        </button>
        <router-link :to="{ name: 'JobCreate' }" custom v-slot="{ navigate }">
          <button @click="navigate" id="jh-create-entity" data-cy="entityCreateButton" class="btn btn-primary jh-create-entity create-job">
            ...
            <span v-text="t$('testappApp.job.home.createLabel')"></span>
          </button>
        </router-link>
      </div>
    </h2>
    ...
    <div class="alert alert-warning" v-if="!isFetching && jobs && jobs.length === 0">
      <span v-text="t$('testappApp.job.home.notFound')"></span>
    </div>
        ...
        <thead>
          <tr>
            ...
            <th scope="row" v-on:click="changeOrder('jobTitle')">
              <span v-text="t$('testappApp.job.jobTitle')"></span>
            ...
            <th scope="row" v-on:click="changeOrder('minSalary')">
              <span v-text="t$('testappApp.job.minSalary')"></span>
            ...
            <th scope="row" v-on:click="changeOrder('maxSalary')">
              <span v-text="t$('testappApp.job.maxSalary')"></span>
            ...
            <th scope="row" v-on:click="changeOrder('employee.id')">
              <span v-text="t$('testappApp.job.employee')"></span>
    ...
    <b-modal ref="removeEntity" id="removeEntity">
      <template #modal-title>
        <span id="testappApp.job.delete.question" data-cy="jobDeleteDialogHeading" v-text="t$('entity.delete.title')"></span>
      </template>
      <div class="modal-body">
        <p id="jhi-delete-job-heading" v-text="t$('testappApp.job.delete.question', { id: removeId })"></p>
      </div>
