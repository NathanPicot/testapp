  ...
  <div class="row justify-content-center">
    <div class="col-8">
      <form name="editForm" role="form" novalidate v-on:submit.prevent="save()">
        <h2
          id="testappApp.location.home.createOrEditLabel"
          data-cy="LocationCreateUpdateHeading"
          v-text="t$('testappApp.location.home.createOrEditLabel')"
        ></h2>
        <div>
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="t$('testappApp.location.streetAddress')" for="location-streetAddress"></label>
            <input
              type="text"
              class="form-control"
              name="streetAddress"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="t$('testappApp.location.postalCode')" for="location-postalCode"></label>
            <input
              type="text"
              class="form-control"
              name="postalCode"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="t$('testappApp.location.city')" for="location-city"></label>
            <input
              type="text"
              class="form-control"
              name="city"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="t$('testappApp.location.stateProvince')" for="location-stateProvince"></label>
            <input
              type="text"
              class="form-control"
              name="stateProvince"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="t$('testappApp.location.country')" for="location-country"></label>
