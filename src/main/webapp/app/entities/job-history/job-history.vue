<template>
  <div>
    <h2 id="page-heading" data-cy="JobHistoryHeading">
      <span v-text="t$('testappApp.jobHistory.home.title')" id="job-history-heading"></span>
      <div class="d-flex justify-content-end">
        <button class="btn btn-info mr-2" v-on:click="handleSyncList" :disabled="isFetching">
          <font-awesome-icon icon="sync" :spin="isFetching"></font-awesome-icon>
          <span v-text="t$('testappApp.jobHistory.home.refreshListLabel')"></span>
        </button>
        <router-link :to="{ name: 'JobHistoryCreate' }" custom v-slot="{ navigate }">
          ...
          >
            ...
            <span v-text="t$('testappApp.jobHistory.home.createLabel')"></span>
          </button>
        </router-link>
      </div>
    </h2>
    ...
    <div class="alert alert-warning" v-if="!isFetching && jobHistories && jobHistories.length === 0">
      <span v-text="t$('testappApp.jobHistory.home.notFound')"></span>
    </div>
      ...
      <table class="table table-striped" aria-describedby="jobHistories">
        <thead>
          <tr>
            ...
            <th scope="row" v-on:click="changeOrder('startDate')">
              <span v-text="t$('testappApp.jobHistory.startDate')"></span>
            ...
            <th scope="row" v-on:click="changeOrder('endDate')">
              <span v-text="t$('testappApp.jobHistory.endDate')"></span>
            ...
            <th scope="row" v-on:click="changeOrder('language')">
              <span v-text="t$('testappApp.jobHistory.language')"></span>
            ...
            <th scope="row" v-on:click="changeOrder('job.id')">
              <span v-text="t$('testappApp.jobHistory.job')"></span>
            ...
            <th scope="row" v-on:click="changeOrder('department.id')">
              <span v-text="t$('testappApp.jobHistory.department')"></span>
            ...
            <th scope="row" v-on:click="changeOrder('employee.id')">
              <span v-text="t$('testappApp.jobHistory.employee')"></span>
        ...
        <tbody>
          <tr v-for="jobHistory in jobHistories" :key="jobHistory.id" data-cy="entityTable">
            ...
            <td v-text="t$('testappApp.Language.' + jobHistory.language)"></td>
            <td>
    ...
    <b-modal ref="removeEntity" id="removeEntity">
      <template #modal-title>
        <span id="testappApp.jobHistory.delete.question" data-cy="jobHistoryDeleteDialogHeading" v-text="t$('entity.delete.title')"></span>
      </template>
      <div class="modal-body">
        <p id="jhi-delete-jobHistory-heading" v-text="t$('testappApp.jobHistory.delete.question', { id: removeId })"></p>
      </div>
