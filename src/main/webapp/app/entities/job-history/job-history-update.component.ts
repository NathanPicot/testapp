      ...
      if (this.jobHistory.id) {
        this.jobHistoryService()
          ...
          .then(param => {
            this.isSaving = false;
            this.previousState();
            this.alertService.showInfo(this.t$('testappApp.jobHistory.updated', { param: param.id }));
          })
          .catch(error => {
            this.isSaving = false;
        ...
        this.jobHistoryService()
          ...
          .then(param => {
            this.isSaving = false;
            this.previousState();
            this.alertService.showSuccess(this.t$('testappApp.jobHistory.created', { param: param.id }).toString());
          })
          .catch(error => {
            this.isSaving = false;
            this.alertService.showHttpError(error.response);
