  ...
  <div class="row justify-content-center">
    <div class="col-8">
      <form name="editForm" role="form" novalidate v-on:submit.prevent="save()">
        <h2
          id="testappApp.jobHistory.home.createOrEditLabel"
          data-cy="JobHistoryCreateUpdateHeading"
          v-text="t$('testappApp.jobHistory.home.createOrEditLabel')"
        ></h2>
        <div>
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="t$('testappApp.jobHistory.startDate')" for="job-history-startDate"></label>
            <div class="d-flex">
              <input
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="t$('testappApp.jobHistory.endDate')" for="job-history-endDate"></label>
            <div class="d-flex">
              <input
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="t$('testappApp.jobHistory.language')" for="job-history-language"></label>
            <select
              class="form-control"
              name="language"
            ...
            >
              <option
                ...
                v-bind:label="t$('testappApp.Language.' + language)"
              >
                {{ language }}
              </option>
            </select>
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="t$('testappApp.jobHistory.job')" for="job-history-job"></label>
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="t$('testappApp.jobHistory.department')" for="job-history-department"></label>
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="t$('testappApp.jobHistory.employee')" for="job-history-employee"></label>
