  ...
  <div class="row justify-content-center">
    <div class="col-8">
      <form name="editForm" role="form" novalidate v-on:submit.prevent="save()">
        <h2
          id="testappApp.department.home.createOrEditLabel"
          data-cy="DepartmentCreateUpdateHeading"
          v-text="t$('testappApp.department.home.createOrEditLabel')"
        ></h2>
        <div>
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="t$('testappApp.department.departmentName')" for="department-departmentName"></label>
            <input
              type="text"
              class="form-control"
              name="departmentName"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="t$('testappApp.department.location')" for="department-location"></label>
