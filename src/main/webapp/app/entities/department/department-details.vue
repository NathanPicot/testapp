    ...
    <div class="col-8">
      <div v-if="department">
        <h2 class="jh-entity-heading" data-cy="departmentDetailsHeading">
          <span v-text="t$('testappApp.department.detail.title')"></span> {{ department.id }}
        </h2>
        <dl class="row jh-entity-details">
          <dt>
            <span v-text="t$('testappApp.department.departmentName')"></span>
          </dt>
          <dd>
            <span>{{ department.departmentName }}</span>
          </dd>
          <dt>
            <span v-text="t$('testappApp.department.location')"></span>
          </dt>
          <dd>
