  ...
  <div class="row justify-content-center">
    <div class="col-8">
      <form name="editForm" role="form" novalidate v-on:submit.prevent="save()">
        <h2
          id="testappApp.employee.home.createOrEditLabel"
          data-cy="EmployeeCreateUpdateHeading"
          v-text="t$('testappApp.employee.home.createOrEditLabel')"
        ></h2>
        <div>
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="t$('testappApp.employee.firstName')" for="employee-firstName"></label>
            <input
              type="text"
              class="form-control"
              name="firstName"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="t$('testappApp.employee.lastName')" for="employee-lastName"></label>
            <input
              type="text"
              class="form-control"
              name="lastName"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="t$('testappApp.employee.email')" for="employee-email"></label>
            <input
              type="text"
              class="form-control"
              name="email"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="t$('testappApp.employee.phoneNumber')" for="employee-phoneNumber"></label>
            <input
              type="text"
              class="form-control"
              name="phoneNumber"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="t$('testappApp.employee.hireDate')" for="employee-hireDate"></label>
            <div class="d-flex">
              <input
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="t$('testappApp.employee.salary')" for="employee-salary"></label>
            <input
              type="number"
              class="form-control"
              name="salary"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="t$('testappApp.employee.commissionPct')" for="employee-commissionPct"></label>
            <input
              type="number"
              class="form-control"
              name="commissionPct"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="t$('testappApp.employee.manager')" for="employee-manager"></label>
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="t$('testappApp.employee.department')" for="employee-department"></label>
