<template>
  <div>
    <h2 id="page-heading" data-cy="EmployeeHeading">
      <span v-text="t$('testappApp.employee.home.title')" id="employee-heading"></span>
      <div class="d-flex justify-content-end">
        <button class="btn btn-info mr-2" v-on:click="handleSyncList" :disabled="isFetching">
          <font-awesome-icon icon="sync" :spin="isFetching"></font-awesome-icon>
          <span v-text="t$('testappApp.employee.home.refreshListLabel')"></span>
        </button>
        <router-link :to="{ name: 'EmployeeCreate' }" custom v-slot="{ navigate }">
          ...
          >
            ...
            <span v-text="t$('testappApp.employee.home.createLabel')"></span>
          </button>
        </router-link>
      </div>
    </h2>
    ...
    <div class="alert alert-warning" v-if="!isFetching && employees && employees.length === 0">
      <span v-text="t$('testappApp.employee.home.notFound')"></span>
    </div>
        ...
        <thead>
          <tr>
            ...
            <th scope="row" v-on:click="changeOrder('firstName')">
              <span v-text="t$('testappApp.employee.firstName')"></span>
            ...
            <th scope="row" v-on:click="changeOrder('lastName')">
              <span v-text="t$('testappApp.employee.lastName')"></span>
            ...
            <th scope="row" v-on:click="changeOrder('email')">
              <span v-text="t$('testappApp.employee.email')"></span>
              <jhi-sort-indicator :current-order="propOrder" :reverse="reverse" :field-name="'email'"></jhi-sort-indicator>
            </th>
            <th scope="row" v-on:click="changeOrder('phoneNumber')">
              <span v-text="t$('testappApp.employee.phoneNumber')"></span>
            ...
            <th scope="row" v-on:click="changeOrder('hireDate')">
              <span v-text="t$('testappApp.employee.hireDate')"></span>
            ...
            <th scope="row" v-on:click="changeOrder('salary')">
              <span v-text="t$('testappApp.employee.salary')"></span>
            ...
            <th scope="row" v-on:click="changeOrder('commissionPct')">
              <span v-text="t$('testappApp.employee.commissionPct')"></span>
            ...
            <th scope="row" v-on:click="changeOrder('manager.id')">
              <span v-text="t$('testappApp.employee.manager')"></span>
            ...
            <th scope="row" v-on:click="changeOrder('department.id')">
              <span v-text="t$('testappApp.employee.department')"></span>
    ...
    <b-modal ref="removeEntity" id="removeEntity">
      <template #modal-title>
        <span id="testappApp.employee.delete.question" data-cy="employeeDeleteDialogHeading" v-text="t$('entity.delete.title')"></span>
      </template>
      <div class="modal-body">
        <p id="jhi-delete-employee-heading" v-text="t$('testappApp.employee.delete.question', { id: removeId })"></p>
      </div>
